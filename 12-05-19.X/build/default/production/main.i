...
# 27 "./UART1.h"
_Bool UART1_Init(const long int baudrate)
{
 int x;
 x = ((8000000 / baudrate)/64)-1;
 ANSELC=0x00;
 TRISC7 = 1;
    TRISC6 = 0;
    SPBRGH1 = x>>8;
...
# 1 "./UART2.h" 1
# 34 "./UART2.h"
_Bool UART2_Init(const long int baudrate)
{
 int x;
 x = ((8000000 / baudrate)/64)-1;
 ANSELD=0x00;
...
# 11 "./System.h" 2
# 37 "./System.h"
unsigned char receiver_count=0,string[255],string1[255];
char Reset_count=0,Server_TMR_Bit;
char IMEI[17],flag=1,SIM_Name[20],MOB_No[15];
_Bool INT0IF_flag=0,delay_bit,Server_sent,receiver_flag=0;
int Timer_count=0,Timer_count_flag=0,Server_TMR;
extern _Bool receiver_check();
...
# 152 "./System.h"
_Bool SIM_Provider_Name()
{
  UART1PutString("AT+CSPN?\r\n",10);
 _delay((unsigned long)((200)*(8000000/4000.0)));flag=0;
 for(int i=0;string[i]!='\0';i++)
 {
     if(string[i]=='"')
     {
         ...
         memset(string,0,255);_delay((unsigned long)((20)*(8000000/4000.0)));
         return 1;
     }
...
_Bool receiver_check()
{
    ...
    if(delay_bit)_delay((unsigned long)((100)*(8000000/4000.0)));


    if(Reset_count==15)__asm(" reset");
...
_Bool SIM_Ready_Check()
{
for(int i=0;string[i]<254;i++)
    {
...
# 262 "./System.h"
 ...
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CMGF=1\r\n",11);}



 UART1PutString("AT+CNMI=2,1,0,0,0\r\n",19);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CNMI=2,1,0,0,0\r\n",19);}


 UART1PutString("AT+CSCS=\"IRA\"\r\n",15);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CSCS=\"IRA\"\r\n",15);}
 UART1PutString("AT+CFGRI=0\r\n",12);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CFGRI=0\r\n",12);}
 UART1PutString("AT+CLIP=1\r\n",11);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CLIP=1\r\n",11);}
 UART1PutString("AT+CUSD=1\r\n",11);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CUSD=1\r\n",11);}
 UART1PutString("AT+CLTS=0\r\n",11);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CLTS=0\r\n",11);}
 UART1PutString("AT+CREG?\r\n",10);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CREG?\r\n",10);}
 UART1PutString("AT+CBC\r\n",9);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CBC\r\n",9);}
 UART1PutString("AT+CSQ\r\n",8);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CSQ\r\n",8);}
 UART1PutString("AT+CGATT?\r\n",11);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CGATT?\r\n",11);}
 UART1PutString("AT+CIPCSGP=1,\"bsnllive\",\"\",\"\"\r\n",31);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CIPCSGP=1,\"bsnllive\",\"\",\"\"\r\n",31);}
 UART1PutString("AT+CSTT=\"bsnllive\",\"\",\"\"\r\n",26);
 while(!receiver_check()){_delay((unsigned long)((2000)*(8000000/4000.0)));UART1PutString("AT+CSTT=\"bsnllive\",\"\",\"\"\r\n",26);}
...
void MSG_check()
{
     if(INT0IF_flag)
    {
        ...
        for(i=0;string[i]!='\0';i++)
       {
            ...
            {
                _delay((unsigned long)((1000)*(8000000/4000.0)));
               UART1PutString("ATH\n\r",5);_delay((unsigned long)((2000)*(8000000/4000.0)));
               memset(string,' ',255);
            }
            if(string[i]=='C'&&string[i+1]=='M'&&string[i+2]=='T'&&string[i+3]=='I')
            {
                 _delay((unsigned long)((200)*(8000000/4000.0)));
                   ...
                   UART1PutString("AT+CMGF=1\n\r",11);_delay((unsigned long)((20)*(8000000/4000.0)));
                 clear_Buffer();
                   UART1PutString("AT+CMGR=1\r\n",11);_delay((unsigned long)((50)*(8000000/4000.0)));
                for(int a=0;a<255;a++)
                            {
                                string1[a] = string[a];
